...
import { type AnyPgColumn, type PrimaryKeyBuilder as DrizzlePrimaryKeyBuilder, type ExtraConfigColumn, ManualViewBuilder, type PgColumnBuilderBase, type PgEnumColumnBuilderInitial, PgTable, type PgTableExtraConfig, type PgTextConfig, type TableConfig, ViewBuilder } from "drizzle-orm/pg-core";
...
export declare const MAX_DATABASE_OBJECT_NAME_LENGTH = 45;
export declare const getLiveQueryTriggerName: () => string;
export declare const getLiveQueryProcedureName: () => string;
export declare const getLiveQueryChannelName: (schema: string) => string;
export declare const getLiveQueryNotifyTriggerName: () => string;
/**
 ...
 */
export declare const getViewsLiveQueryNotifyTriggerName: (viewsSchema: string) => string;
export declare const getLiveQueryNotifyProcedureName: () => string;
export declare const getLiveQueryTempTableName: () => string;
export declare const getPartitionName: (table: string | PgTable, chainId: number) => string;
export declare const getReorgTableName: (table: string | PgTable) => string;
export declare const getReorgTriggerName: () => string;
export declare const getReorgProcedureName: (table: string | PgTable) => string;
export declare const getReorgSequenceName: () => string;
    ...
    columns: { [Key in keyof columns]: import("drizzle-orm/pg-core").PgColumn<{
        ...
        baseColumn: Omit<columns[Key]["_"], "name"> & {
            ...
            baseColumn: U_1["_"] extends infer T_13 ? T_13 extends U_1["_"] ? T_13 extends {
                baseBuilder: infer U_1 extends ColumnBuilderBase<import("drizzle-orm").ColumnBuilderBaseConfig<import("drizzle-orm").ColumnDataType, string>, object>;
            } ? import("drizzle-orm").Column<any, {}, Omit<U_1["_"], "name" | "dataType" | "columnType" | "data" | "driverParam" | "enumValues" | "dialect" | "tableName" | "notNull" | "hasDefault" | "isPrimaryKey" | "isAutoincrement" | "hasRuntimeDefault" | "identity" | "brand" | "generated" | "baseColumn"> extends infer T_14 ? { [K in keyof T_14]: Omit<U_1["_"], "name" | "dataType" | "columnType" | "data" | "driverParam" | "enumValues" | "dialect" | "tableName" | "notNull" | "hasDefault" | "isPrimaryKey" | "isAutoincrement" | "hasRuntimeDefault" | "identity" | "brand" | "generated" | "baseColumn">[K]; } : never> : never : never : never;
        ...
        }, {}, Omit<U_1["_"], "name" | "dataType" | "columnType" | "data" | "driverParam" | "enumValues" | "dialect" | "tableName" | "notNull" | "hasDefault" | "isPrimaryKey" | "isAutoincrement" | "hasRuntimeDefault" | "identity" | "brand" | "generated" | "baseColumn"> extends infer T_17 ? { [K in keyof T_17]: Omit<U_1["_"], "name" | "dataType" | "columnType" | "data" | "driverParam" | "enumValues" | "dialect" | "tableName" | "notNull" | "hasDefault" | "isPrimaryKey" | "isAutoincrement" | "hasRuntimeDefault" | "identity" | "brand" | "generated" | "baseColumn">[K]; } : never> : never : never : never;
        ...
        name: columns[Key]["_"]["name"] extends "" ? import("drizzle-orm").Assume<Key, string> : columns[Key]["_"]["name"];
    }, "name" | "dataType" | "columnType" | "data" | "driverParam" | "enumValues" | "dialect" | "tableName" | "notNull" | "hasDefault" | "isPrimaryKey" | "isAutoincrement" | "hasRuntimeDefault" | "identity" | "brand" | "generated" | "baseColumn"> extends infer T_20 ? { [K_1 in keyof T_20]: Omit<Omit<columns[Key]["_"], "name"> & {
        name: columns[Key]["_"]["name"] extends "" ? import("drizzle-orm").Assume<Key, string> : columns[Key]["_"]["name"];
    }, "name" | "dataType" | "columnType" | "data" | "driverParam" | "enumValues" | "dialect" | "tableName" | "notNull" | "hasDefault" | "isPrimaryKey" | "isAutoincrement" | "hasRuntimeDefault" | "identity" | "brand" | "generated" | "baseColumn">[K_1]; } : never>; };
    extra: extra;
    dialect: "pg";
}>;
/**
 ...
 */
export declare function onchainView<TName extends string>(name: TName): ViewBuilder<TName>;
export declare function onchainView<TName extends string, TColumns extends Record<string, PgColumnBuilderBase>>(name: TName, columns: TColumns): ManualViewBuilder<TName, TColumns>;
