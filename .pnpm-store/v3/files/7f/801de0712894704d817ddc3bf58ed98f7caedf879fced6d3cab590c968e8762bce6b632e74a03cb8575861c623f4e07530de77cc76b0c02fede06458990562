...
import { ManualViewBuilder, PgEnumColumnBuilder, PgTable, ViewBuilder, primaryKey as drizzlePrimaryKey, } from "drizzle-orm/pg-core";
...
export const getLiveQueryChannelName = (schema) => {
 ...
 */
export const getViewsLiveQueryNotifyTriggerName = (viewsSchema) => {
...
export function onchainView(name, columns) {
    const schema = globalThis?.PONDER_NAMESPACE_BUILD?.schema;
