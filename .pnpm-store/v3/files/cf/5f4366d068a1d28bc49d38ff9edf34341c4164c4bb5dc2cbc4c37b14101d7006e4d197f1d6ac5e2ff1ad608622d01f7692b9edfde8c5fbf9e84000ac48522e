...
export type Database = {
     ...
     */
    migrate({ buildId, chains, finalizedBlocks, }: Pick<IndexingBuild, "buildId" | "chains" | "finalizedBlocks">): Promise<CrashRecoveryCheckpoint>;
};
...
export declare const PONDER_META_TABLE_NAME = "_ponder_meta";
/**
 * @dev Used since version 0.11.
 */
export declare const PONDER_CHECKPOINT_TABLE_NAME = "_ponder_checkpoint";
/**
 * @dev Used from version 0.9 to 0.11.
 */
export declare const PONDER_STATUS_TABLE_NAME = "_ponder_status";
...
export declare const getPonderCheckpointTable: (schema?: string) => import("drizzle-orm/pg-core").PgTableWithColumns<{
    ...
    columns: {
        ...
        finalizedCheckpoint: import("drizzle-orm/pg-core").PgColumn<{
